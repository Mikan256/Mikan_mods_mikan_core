...
public class ItemMikanJuice100 extends Item {
    ...
    public ItemMikanJuice100(){
        super(new Properties().tab(MikanTabinit.Mikan_tab).food(new Food.Builder().nutrition(6).saturationMod(2.0F).effect(new EffectInstance(Effects.NIGHT_VISION,600,1),1F).build()));
